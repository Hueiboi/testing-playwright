Feature: Kiểm tra kết nối và tương tác Jira
  ...
  Scenario: Viết bình luận vào công việc thành công
    Given Tôi đã nạp Cookies vào trình duyệt
    When Tôi truy cập vào trang "https://our-testing.atlassian.net/browse/SCRUM-1" 
  ...
  Scenario: Tạo Sprint mới thành công
    Given Tôi đã nạp Cookies vào trình duyệt
    When Tôi truy cập vào trang "https://our-testing.atlassian.net/jira/software/c/projects/SCRUM/boards/3/backlog"
